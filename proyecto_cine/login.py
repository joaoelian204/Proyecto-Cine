...
# Credenciales para el inicio de la app
USUARIO = "admin"
CONTRASEÑA = "1"

def verificar_credenciales(usuario, contraseña):
    return usuario == USUARIO and contraseña == CONTRASEÑA
...
def mostrar_login(root, on_login_success):
    ...
    tk.Button(login_window, text="Iniciar Sesión", command=intentar_login, font=("Arial", 14), bg="#2980b9", fg="#ecf0f1", bd=0, relief=tk.FLAT, padx=10, pady=10).pack(pady=40)
