...
def mostrar_perfil(cuerpo_principal, usuario):
    ...
    Args:
        ...
        usuario (dict): Un diccionario con los detalles del usuario.
    """
    ...
    try:
        imagen = Image.open(usuario["imagen"])
        imagen_resized = imagen.resize((150, 150))  # Ajustar el tamaño de la imagen
